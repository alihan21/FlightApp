...
namespace FlightApp.Backend.Data
{
    public class FlightAppInit
    {
        ...
        //                flightBelgiumBulgaria.Passengers = new List<UserFlight>() { arthurflightBelgiumBulgaria, noahflightBelgiumBulgaria, adamflightBelgiumBulgaria };
        //                flightBrazilAntarctic.Passengers = new List<UserFlight>() { louisflightBrazilAntarctic, liamflightBrazilAntarctic, lucasflightBrazilAntarctic, julesflightBrazilAntarctic };
        //                flightChinaUsa.Passengers = new List<UserFlight>() { victorflightChinaUsa, gabrielflightChinaUsa, mohamedflightChinaUsa };
        //                #endregion
        ...
        //                arthur.PassengerFlights = new List<UserFlight>() { arthurflightBelgiumBulgaria};
        //                noah.PassengerFlights = new List<UserFlight>() { noahflightBelgiumBulgaria};
        //                adam.PassengerFlights = new List<UserFlight>() { adamflightBelgiumBulgaria};
        //                louis.PassengerFlights = new List<UserFlight>() { louisflightBrazilAntarctic};
        //                liam.PassengerFlights = new List<UserFlight>() { liamflightBrazilAntarctic};
        //                lucas.PassengerFlights = new List<UserFlight>() { lucasflightBrazilAntarctic};
        //                jules.PassengerFlights = new List<UserFlight>() { julesflightBrazilAntarctic};
        //                victor.PassengerFlights = new List<UserFlight>() { victorflightChinaUsa};
        //                gabriel.PassengerFlights = new List<UserFlight>() { gabrielflightChinaUsa};
        //                mohamed.PassengerFlights = new List<UserFlight>() { mohamedflightChinaUsa};
        ...
        //            return seats;
        //        }
        //        private UserFlight FillPassengerInAFlight(Passenger passenger, Flight flight)
        //        {
